...
import { signIn } from "@/features/settings/store";

// Returning sign-in — email only, no password, no verification (v1 local-first).
    ...
    <div className="mx-auto flex min-h-full w-full max-w-[440px] flex-1 flex-col justify-center px-6 py-16">
      <header className="text-center">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          Enter your email to continue. No password — your progress on this
          device is exactly as you left it.
        </p>
      </header>
